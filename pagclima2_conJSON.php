...
if(isset($_POST["id"])){
	...
	//print_r($resultado);
	$resultado = json_decode($resultado, true); //ACA ESTA EL JSON FRUTA
//	print_r($resultado);
	if ($resultado) {
...
<body>
	...
	<div class='container'>
		...
		<div id="resultados">
			<textarea name="resultados" rows="10" cols="70" disabled placeholder="Aquí se mostrarán los resultados de su búsqueda">
				<?php if (isset($weather)) echo $weather." - ".$description;  ?>
			</textarea>
		</div>
		<div id="busquedas">
			<textarea name="textarea" rows="10" cols="50" disabled placeholder="Aquí se mostrarán los resultados de sus antiguas búsquedas">
				<?php
				if(isset($_SESSION["memoria"])){
